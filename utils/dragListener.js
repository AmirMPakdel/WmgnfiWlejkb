...
export function handleDragMousemoveXY(event) {
    ...
    function adjustWindowScroll() {
        ...
        if ( isInLeftEdge && canScrollLeft ) {
            ...
            nextScrollX = ( nextScrollX - 50/*( maxStep * intensity )*/ );
        ...
        if ( isInTopEdge && canScrollUp ) {
            ...
            nextScrollY = ( nextScrollY - 50/*( maxStep * intensity )*/ );
        ...
        nextScrollX = Math.max( 0, nextScrollX);
        nextScrollY = Math.max( 0, nextScrollY );
...
export function handleDragMousemoveY(event){
    ...
    function adjustWindowScroll() {
        ...
        nextScrollY = nextScrollY>0?nextScrollY:0;
...
export function clearDragMousemoveTimer(){
    clearTimeout( timer );
}