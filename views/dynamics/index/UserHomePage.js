import UserHomePageController from "@/controllers/dynamics/index/UserHomePageController";
...
/**
* Props of UserHomePage Component
* @typedef Props
...
export default class UserHomePage extends Component {
    ...
    constructor(props){
        super(props);
        this.controller = new UserHomePageController(this);
        this.state = {
            loading:true,
            show_default:false,
            elements:[],
