...
import styles from "./SoldCourse.module.css";
...
import SoldCourseController from "@/controllers/transaction/SoldCourseController";
const persianNToText = require('number-to-persian-text');

/**
* Props of SoldCourse Component
* @typedef Props
...
export default class SoldCourse extends Component {
    ...
    constructor(props){
        super(props);
        this.controller = new SoldCourseController(this);
        this.state = {
            loading:true,
            details:{},
        }
